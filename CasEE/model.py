...
class CasEE(nn.Module):
    ...
    def forward(self, tokens, segment, mask, type_id, type_vec, trigger_s_vec, trigger_e_vec, relative_pos,
                trigger_mask, args_s_vec, args_e_vec, args_mask):
        """
        ...
        :param type_id
        :param type_vec
        :param trigger_s_vec: [b, t]
        :param trigger_e_vec: [b, t]
        :param relative_pos:
        :param trigger_mask: [0000011000000]
        :param args_s_vec: [b, l, t]
        :param args_e_vec: [b, l, t]
        :param args_mask: [b, k]
        :return:
        """
