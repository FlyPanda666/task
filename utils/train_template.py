...
from function_module import EarlyStopping
from utils.my_logger import create_logger
...
def train(model, train_dataset, validate_dataset, args, logger):
    train_dataloader = DataLoader(
        train_dataset, batch_size=args.batch_size, shuffle=True, num_workers=args.num_workers, collate_fn=collate_fn,
        drop_last=True
    )
    validate_dataloader = DataLoader(
        validate_dataset, batch_size=args.batch_size, shuffle=True,
