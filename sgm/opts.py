def model_opts(parser):
    ...
    parser.add_argument('-gpus', default=[0, 1, 2, 3], nargs='+', type=int, help="use CUDA on the listed devices.")
#     parser.add_argument('-restore', default=None, type=str, help="restore checkpoint")
    parser.add_argument('-restore', default="./experiments/1670932828174/best_micro_f1_checkpoint.pt", type=str, help="restore checkpoint")
    ...
    parser.add_argument('-log', default='./yaqiang1/', type=str, help="log directory")
    ...
    parser.add_argument('-label_dict_file', default='./data/topic_sorted.json', type=str, help="label_dict")
